...
export default function ParticipantDetailPage() {
  ...
  const handleSacramentChange = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    // --- FIX IS HERE: The `err` variable is prefixed with an underscore to ignore it ---
    try {
    ...
    } catch (_err: unknown) { // <-- The underscore tells the linter we are intentionally not using this variable
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-gray-600 dark:text-gray-300">
                {/* --- FIX IS HERE: Escaped apostrophes --- */}
